    ...
    <asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <div class="webBorder">
          <div class="filterBox">
               ...
               <asp:DropDownList id="typeList" AutoPostBack="False" runat="server" CssClass="item">
                            ...
                            <div class="adminBox">
                                <asp:Panel runat="server" ID="InsertOrUpdate" CssClass="visible">
                                       <asp:Panel runat="server" ID="onlyUpdateID" CssClass="invisible">
                                        ...
                                        <asp:label runat="server" width="35%"> Type </asp:label><asp:DropDownList id="TypeTB" CssClass="ddlstyle" runat="server">
