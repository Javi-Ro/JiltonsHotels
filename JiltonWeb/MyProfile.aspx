                ...
                <asp:Panel ID="MyInfoPanel" runat="server">
                    ...
                    <div id="bothFlex">
                        ...
                        <div id="textBoxFlex">
                            ...
                            <asp:TextBox ID ="AgeText" CssClass="modifiable" ReadOnly="true" Text="" Height="30px" style="text-align:left; border-radius:3px; border-width:1px; padding: 0px 4px; margin-right:2px" OnKeyPress="return false;" AutoComplete="off" runat ="server" />
